...
import { Brain, Calendar, BookOpen, Bell, Sun, Moon, X, Target, TrendingUp, BarChart3, PenTool } from 'lucide-react';
...
export function MobileSidebar({ isOpen, onClose, activeTab, onTabChange, theme, onThemeToggle }: MobileSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed left-0 top-0 bottom-0 w-64 bg-white dark:bg-gray-900 z-50 md:hidden transform transition-transform duration-300">
        {/* Header */}
